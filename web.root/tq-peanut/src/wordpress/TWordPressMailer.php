...
if (!class_exists('\PHPMailer')) {
    include_once (TPath::fromFileRoot('wp-includes/class-phpmailer.php'));
}

/**
 * Class TWordPressMailer
 * @package Tops\wordpress
 *
 * Note that this class is identical to TPhpMailer in the tops.phpmailer project.
 * WordPress uses PhpMailer but does not use namespaces.  For this reason, I had to "clone" the code.
 */
class TWordPressMailer
{
